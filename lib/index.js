(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('echarts/lib/echarts'), require('echarts/lib/component/tooltip'), require('echarts/lib/component/legend'), require('echarts/lib/chart/bar'), require('echarts/lib/chart/line'), require('echarts/lib/chart/pie'), require('echarts/lib/chart/funnel'), require('echarts/lib/chart/radar'), require('echarts/lib/chart/map'), require('echarts/extension/bmap/bmap'), require('echarts/lib/chart/sankey'), require('echarts/lib/chart/heatmap'), require('echarts/lib/component/visualMap')) :
	typeof define === 'function' && define.amd ? define(['echarts/lib/echarts', 'echarts/lib/component/tooltip', 'echarts/lib/component/legend', 'echarts/lib/chart/bar', 'echarts/lib/chart/line', 'echarts/lib/chart/pie', 'echarts/lib/chart/funnel', 'echarts/lib/chart/radar', 'echarts/lib/chart/map', 'echarts/extension/bmap/bmap', 'echarts/lib/chart/sankey', 'echarts/lib/chart/heatmap', 'echarts/lib/component/visualMap'], factory) :
...
var getMapJSON = function getMapJSON(position, positionJsonLink) {
  var link = positionJsonLink || '' + MAP_URL_PREFIX + position + '.json';
  return $get(link);
};
...
var map = function map(columns, rows, settings, extra) {
  ...
  return getMapJSON(position, positionJsonLink).then(function (json) {
  ...
  return {
    ...
    formatter: function formatter(_ref) {
      var color$$1 = _ref.color,
          _ref$data = slicedToArray(_ref.data, 3),
          xDim = _ref$data[0],
          yDim = _ref$data[1],
          value = _ref$data[2];
      ...
      tpl.push(itemPoint(color$$1) + ' ' + innerXAxisList[xDim] + ': ');
      tpl.push(getFormated(value, dataType, digit));
      return tpl.join('');
    }
  };
...
var heatmap = function heatmap(columns, rows, settings, status) {
  ...
  if (type === 'bmap') {
    ...
    return getMapJSON(position, positionJsonLink).then(function (json) {
      ...
      if (beforeRegisterMap) json = beforeRegisterMap(json);
      echarts.registerMap(position, json);
      console.log(_extends({ geo: geoAttr }, options));
...
var components = [VeBar, VeHistogram, VeLine, VePie, VeRing, VeWaterfall, VeFunnel, VeRadar, VeChart, VeMap, VeBmap, VeSankey, VeHeatmap];
